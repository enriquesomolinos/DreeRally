...
// carry flag of left shift
 int8 __MKCSHL__(int value, uint count)
{
  const uint nbits = sizeof(int) * 8;
  count %= nbits;
...
int8 __MKCSHR__(int value, uint count)
{
