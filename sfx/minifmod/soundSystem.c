...
//void *  sub_43AD80(int soundEffectSize)
{
 ...
 // v1 = data + 4;
  ...
  //v1 = *(const void **)(a1 + 4);
  v2 = size;//strlen(name); //es el tama�o del audio
  //v2 = *(_DWORD *)soundEffectSize; //es el tama�o del audio
 // v3 = calloc(0xCu, 1u);
  handle = v3;
  *(_DWORD *)v3 = v2;
  v5 = calloc(v2, 1u);
 ...
 v6 = handle->size; //v4 es el tama�o del audio
...
int   FMUSIC_UpdateXMNote_43EC40(FMUSIC_MODULE *mod, int channelId, unsigned __int8 soundId, int a4, char volume)
{
  ...
  if ( soundId < mod->numinsts )//a1+32
  {
    ...
    cprt_inst_v9 = soundId;//v9 = 340 * soundId; 340 es el tama�o de instrumet
